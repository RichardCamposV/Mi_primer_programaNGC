...
deathday = birth_date + datetime.timedelta(days=lifespan*365)
days_to_death = deathday - datetime.datetime.now()

print("Fecha de muerte {}, te queda {} dias para morir".format(deathday.strftime("%d/%m/%Y"), days_to_death.days))
